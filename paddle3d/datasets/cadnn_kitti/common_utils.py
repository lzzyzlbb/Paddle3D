...
def init_dist_slurm(tcp_port, local_rank, backend='nccl'):
    ...
    paddle.cuda.set_device(proc_id % num_gpus)
...
def init_dist_pypaddle(tcp_port, local_rank, backend='nccl'):
    if mp.get_start_method(allow_none=True) is None:
        mp.set_start_method('spawn')

    num_gpus = paddle.cuda.device_count()
    paddle.cuda.set_device(local_rank % num_gpus)
