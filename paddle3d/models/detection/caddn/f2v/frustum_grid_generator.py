...
class FrustumGridGenerator(nn.Layer):
    ...
    def __init__(self, grid_size, pc_range, disc_cfg):
        ...
        self.voxel_grid = self.voxel_grid.transpose([0, 1, 3, 2, 4])  # XZY-> XYZ
    ...
    def grid_to_lidar_unproject(self, pc_min, voxel_size):
        ...
        unproject = paddle.to_tensor([[x_size, 0, 0, x_min],
                                  [0, y_size, 0, y_min],
                                  [0,  0, z_size, z_min],
                                  [0,  0, 0, 1]],
    ...
    def forward(self, lidar_to_cam, cam_to_img, image_shape):
        ...
        image_depth = paddle.to_tensor([self.disc_cfg["num_bins"]]).cast(image_shape.dtype)
